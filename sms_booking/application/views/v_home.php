		...
		<div class="row" style="display: flex; flex-direction: row;">
				<div class="col-md-6" style="display: flex; flex-direction: row; padding: 10px 20px 10px 10px;">
					...
					<div class="group">
					    ...
					    <input type='text' class=" datepicker" name="check_out_date" id="check_out_date" value=""/>
					</div>
				</div>
		...
		<div class="row" >
			...
			$photos = $CI->m_room_type->get_room_type_photos($rt->id_room_type);
				...
				<div class="row room_type">
					...
					<div class="col-md-5">
						<?php 
						$price = ($lang == 'en') ? number_format($rt->default_rate,2).'/Night' : 'ราคา '.number_format($rate,0).'/คืน';
						?>
