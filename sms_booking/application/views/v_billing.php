...
<div class="container_progress_bar">
  ...
  <div class="container-fluid" >
  	<div class="row">
  		<div class="col-md-12 price room_type_header">Step 2 Billing</div>
  	</div>
  	<div class="row"> 
  		<div class="col-md-12">
  		...
  		<page size="A4">
			...
			<div class="page_content">
				<div class="row">
					...
					<div class="col-md-6">
						<div class="price" style="margin-top: 40px; font-size: 1.3em; text-align: center; font-style: italic; font-weight: bold; color: white; padding: 2px 0 2px 0;"><span>Booking Number: <?php echo $booking_number;?></span></div>
					</div>
				</div>
				...
				<div class="row mt-3">
					<div class="col-md-6">
						<div class="row mt-3" style="margin-left: 15px;">
							...
							<div class="col-md-6"><?php echo $guest->firstname;?> <?php echo $guest->lastname;?></div>
							<div class="col-md-6">Contact Number: </div>
							<div class="col-md-6"><?php echo $guest->contact_number;?></div>						
						</div>
					</div>
					<div class="col-md-6">
				...
				<div class="row mt-3" style="margin: 1px 0 1px 15px;">
					...
					<div style="color: white; font-weight: bold; font-size: 1.2em; padding: 3px 0 0 0;">Notes:</div>
					<p style="padding: 3px 15px 3px 15px;">This will serve as your invoice . Please settle the amount stated within 2 hours, then proceed to the next step for the confirmation of your booking. Thank you.</p>
					</div>
				</div>
			</div> <!-- page content -->
