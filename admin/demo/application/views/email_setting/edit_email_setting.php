            ...
            <div class="row">
                ...
                <div class="col-md-12" style="margin:15px 0px 0px 15px; padding-right:30px;" v-show="step == '1'">
                    ...
                    <div style="margin-top:20px;">
                        <button class="btn" style="width:200px; float:right; background-color:#809f4e; color:white;" @click="saveEmailSetting('booked')"><?= _r('Save', 'บันทึก'); ?> Booked Email</button>
                    </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="col-md-12" style="margin:15px 0px 0px 15px; padding-right:30px;" v-show="step == '2'">
                    ...
                    <?php if (has_permission('edit_email_setting', 'edit')) : ?>
                    <div style="margin-top:20px;">
                        <button class="btn" style="width:200px; float:right; background-color:#809f4e; color:white;" @click="saveEmailSetting('verifying')"><?= _r('Save', 'บันทึก'); ?> Verifying Email</button>
                    </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="col-md-12" style="margin:15px 0px 0px 15px; padding-right:30px;" v-show="step == '3'">
                    ...
                    <?php if (has_permission('edit_email_setting', 'edit')) : ?>
                    <div style="margin-top:20px;">
                        <button class="btn" style="width:200px; float:right; background-color:#809f4e; color:white;" @click="saveEmailSetting('confirmed')"><?= _r('Save', 'บันทึก'); ?> Confirmed Email</button>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
