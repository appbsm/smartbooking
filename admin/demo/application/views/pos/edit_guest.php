        ...
        <div class="modal-dialog modal-lg" role="document" style="height:90vh;">
            <div class="modal-content" style="height:100%;">
                ...
                <div class="modal-body" style="overflow-y:auto;">
                    ...
                    <button class="btn btn-sm" style="float:right; font-size:13px; background-color:#809f4e; color:white; margin-bottom:20px;" @click="loadEditDiscount(0)"><?= _r('Add New Discount', 'เพิ่มส่วนลดใหม่'); ?></button>
                    <?php endif; ?>
                    ...
                    <div class="col-md-11">
                        ...
                        <div class="row" style="margin-top:15px">
                            <div class="col-md-12" style="text-align:center">
                                <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#809f4e; color:white;" @click="saveDiscount()">{{ edit_discount.id_discount == 0 ? '<?= _r('Add', 'เพิ่ม'); ?>' : '<?= _r('Update', 'แก้ไข'); ?>' }}</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <button class="btn" data-toggle="modal" data-target="#discountModal" style="float:right; width:120px; height:30px; line-height:9px; background-color:#809f4e; color:white;"><?= _r('Edit Discount', 'จัดการส่วนลด'); ?></button>
                    <?php endif; ?>
                    <div class="col-md-11" style="margin-top:50px;">
                        ...
                        <div class="row" style="margin-top:15px">
                            <div class="col-md-12" style="text-align:center">
                                <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#809f4e; color:white;" @click="saveGuest()"><?php echo empty($guest['id_guest']) ? _r('Add', 'เพิ่ม') : _r('Update', 'แก้ไข'); ?></button>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
