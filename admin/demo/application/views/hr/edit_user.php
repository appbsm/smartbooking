                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row" style="margin-top:15px">
                            <div class="col-md-12" style="text-align:center">
                                <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#809f4e; color:white;" @click="changePassword()"><?= _r('Submit', 'ตกลง'); ?></button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12">
                    <button class="btn" data-toggle="modal" data-target="#changePasswordModal" style="float:right; width:150px; height:30px; line-height:9px; background-color:#809f4e; color:white; margin-bottom:20px;">
                ...
                <div class="col-md-10 offset-md-1">
                    <div class="col-md-11" style="margin-top:30px;">
                        ...
                        <div class="row" style="margin-top:20px">
                            <div class="col-md-12" style="text-align:center">
                                <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#809f4e; color:white;" @click="saveUser()"><?php echo empty($user['id_user']) ? "Add" : "Update"; ?></button>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
