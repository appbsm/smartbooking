                    ...
                    <div class="col-md-11" style="margin-top:30px;">
                        ...
                        <div class="row" style="margin-top:20px">
                            <div class="col-md-12" style="text-align:center">
                                <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#809f4e; color:white;" @click="saveRole()"><?php echo empty($role['id_role']) ? "Add" : "Update"; ?></button>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
