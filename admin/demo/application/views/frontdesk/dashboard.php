    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12" style="font-size:18px; font-weight:bold; text-align:center; vertical-align:middle; height:40px; line-height:40px; background-color:#809f4e; color:white;">
                            {{ menu }}
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <span style="width:100%; text-align:right;">
                            <a href="<?php echo edit_booking_url(); ?>" style="color:white;">    
                                <button class="btn" style="float:right; width:170px; height:30px; line-height:9px; background-color:#809f4e; color:white; margin-top:10px;">
                    ...
                    <div class="row" style="margin-top:25px;">
                        <div class="col-md-4" style="min-width:300px; height:350px; margin-top:5px;">
                            <div style="color:white; font-weight:bold; overflow:hidden; white-space:nowrap; border:1px solid #e0dcdc; padding-left:15px; padding-right:10px; width:100%; height:40px; line-height:40px; background-color:#809f4e;">
