    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?php echo home_url(); ?>" class="brand-link">
                ...
                <span class="brand-text font-weight-light">SMS Booking</span-->
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        ...
                        <a href="<?php echo edit_user_url($s['id_user']); ?>" class="d-block"><?php echo $s['name']; ?></a>
                    </div>
                </div>
                <!-- SidebarSearch Form -->
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <?php endif; ?>
                        <?php if (has_permission('project_management', 'view') || has_permission('room_management', 'view') || has_permission('extra_management', 'view') || has_permission('package_management', 'view') || has_permission('discount_management', 'view') || has_permission('edit_email_setting', 'view') || has_permission('edit_config_setting', 'view')) : ?>
                            <li class="<?php echo $active_menu == 'setting' ? 'nav-item menu-is-opening menu-open' : 'nav-item'; ?>">
                                ...
                                <ul class="nav nav-treeview" style="margin-left:25px">
                                    ...
                                    <?php endif; ?>
                                    <!-- Mychelle -->
                                    <?php if (has_permission('gallery_management', 'view')) : ?>
                                        <li class="nav-item">
                                            <a href="<?php echo gallery_management_url(); ?>" class="nav-link">
                                                <i class="fa fa-home nav-icon"></i>
                                                <p><?= _r('Gallery Management', 'ตั้งค่าอัลบั้ม'); ?></p>
                                            </a>
                                        </li>
                                    <?php endif; ?>
                                    <!-- End Mychelle -->
									<!-- Mychelle 16-11-2023 -->
										...
										<li class="nav-item">
											<a href="<?php echo sms_unit_management_url(); ?>" class="nav-link">
												<i class="fa fa-home nav-icon"></i>
												<p><?= _r('Unit Management', 'Unit Management'); ?></p>
											</a>
										</li>
									<?php endif; ?>
									<!-- End Mychelle -->
