            ...
            <div class="row">
                <div class="col-md-10 offset-md-1">
                    ...
                    <span style="width:100%;">
                        <button class="btn" style="float:right; width:150px; height:30px; line-height:9px; background-color:#809f4e; color:white; margin-bottom:20px;" @click="loadEditDiscount(0)">
