    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="col-md-12 text-right">
                ...
                <span style="width:100%; t">
                    <a href="<?php echo edit_booking_url(); ?>" style="color:white;">    
                        <button class="btn" style="width:170px; height:30px; line-height:9px; background-color:#0275d8; color:white; margin-top:-25px;">
                ...
                <span style="width:100%; text-align:right;">
                    <a href="<?php echo late_booking_url(); ?>" style="color:white;">    
                        <button class="btn" style=" width:170px; height:30px; line-height:9px; background-color:#0275d8; color:white; margin-top:-25px;">
                            <?= _r('Late Booking', 'Late Booking'); ?>
                        </button>
                    </a>
                </span>
                <?php endif; ?>
