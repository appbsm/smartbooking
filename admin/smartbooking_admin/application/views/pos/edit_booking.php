                    ...
                    <div class="row" style="margin-top:5px">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control" v-model="booking_info.status" id="status" :disabled="disable == 1">
                                ...
                                <option value="Checked-out" v-if="['Checked-in', 'Checked-out'].includes(old_booking_info.status)">Checked-out</option>
                ...
                <div class="col-md-12">
                    <div class="row" style="margin-top:15px">
                        <div class="col-md-12" style="text-align:center">
                            <button class="btn" style="width:200px; height:34.5px; line-height:9px; background-color:#0275d8; color:white;" @click="saveBookingInfo()"><?= _r('Save', 'บันทึก'); ?></button>
                        </div>
                    </div>
                </div>
                <!-- Check-in -->
...
$(document).ready(function() {
    app = new Vue({
        el: '#vApp',
        data: {
            menu: '<?php echo empty($booking_info['id_booking']) ? _r("Add Booking", "เพิ่มการจอง") : _r("Update Booking", "แก้ไขการจอง"); ?>',
