        ...
        <div class="modal-dialog modal-lg" role="document" style="height:94vh;">
            <div class="modal-content" style="height:100%;">
                ...
                <div class="modal-body" style="overflow-y:auto;">
                    ...
                    <button class="btn btn-sm" style="float:right; font-size:13px; background-color:#0275d8; color:white; margin-bottom:20px;" @click="loadEditAmenity(0)"><?= _r('Add New Amenity', 'เพิ่ม Amenity ใหม่'); ?></button>
                    <?php endif; ?>
                    ...
                    <div class="col-md-11">
                        ...
                        <div class="row" style="margin-top:15px">
                            <div class="col-md-12" style="text-align:center">
                                <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#0275d8; color:white;" @click="saveAmenity()">{{ edit_amenity.id_amenities == 0 ? '<?= _r("Add", "เพิ่ม"); ?>' : '<?= _r("Update", "แก้ไข"); ?>' }}</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content" style="height:100%;">
                ...
                <div class="modal-body" style="overflow-y:auto;">
                    <div class="col-md-12">
                        ...
                        <div class="row" style="margin-top:15px">
                            <div class="col-md-12" style="text-align:center">
                                <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#0275d8; color:white;" @click="updateRoomDetail()"><?= _r('Update', 'แก้ไข'); ?></button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content" style="height:100%;">
                ...
                <div class="modal-body" style="overflow-y:auto;">
                    <div class="col-md-11">
                        ...
                        <div class="row" style="margin-top:15px">
                            <div class="col-md-12" style="text-align:center">
                                <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#0275d8; color:white;" @click="saveSeasonalPrice('update')"><?= _r('Update', 'แก้ไข'); ?></button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12" v-show="step == '1'">
                    ...
                    <div class="col-md-11" style="margin-top:50px;">
                        ...
                        <div class="row" style="margin-top:15px">
                            <div class="col-md-12" style="text-align:center">
                                <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#0275d8; color:white;" @click="saveRoomTypeInfo()"><?= _r('Save', 'บันทึก'); ?></button>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="col-md-11" style="margin-top:50px; text-align:center;" v-if="room_type_info.id_room_type">
                        ...
                        <div class="row" style="margin-top:15px">
                            <div class="col-md-12" style="text-align:center">
                                <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#0275d8; color:white;" @click="savePhotoRoomType()"><?= _r('Save', 'บันทึก'); ?></button>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="col-md-12" v-show="step == '2'">
                    <div class="col-md-12" style="margin-top:50px;">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <button class="btn" data-toggle="modal" data-target="#amenityModal" style="float:right; width:150px; height:30px; line-height:9px; background-color:#0275d8; color:white;"><?= _r('Edit', 'จัดการ'); ?> Amenities</button>
                            </div>
                            <?php endif; ?>
                        </div>
                ...
                <div class="col-md-12" v-show="step == '3'">
                    <div class="col-md-11" style="margin-top:50px;">
                        ...
                        <div class="row" style="margin-top:15px">
                            <div class="col-md-12" style="text-align:center">
                                <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#0275d8; color:white;" @click="addRoomDetail()"><?= _r('Add New', 'เพิ่มใหม่'); ?></button>
                            </div>
                        </div>
                        <?php endif; ?>
                    ...
                    <div class="col-md-11" style="margin-top:50px;">
                        <div class="row" style="margin-top:40px">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row" style="margin-top:15px">
                                    <div class="col-md-12" style="text-align:center">
                                        <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#0275d8; color:white;" @click="saveSeasonalPrice('add')"><?= _r('Add New', 'เพิ่มใหม่'); ?></button>
                                    </div>
                                </div>
                            </div>
                            <?php endif; ?>
