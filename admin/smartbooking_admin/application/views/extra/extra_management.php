                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row" style="margin-top:15px">
                            <div class="col-md-12" style="text-align:center">
                                <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#0275d8; color:white;" @click="updateExtra()"><?= _r('Update', 'แก้ไข'); ?></button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-10 offset-md-1">
                    ...
                    <div class="row" style="margin-top:15px">
                        <div class="col-md-12" style="text-align:center">
                            <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#0275d8; color:white;" @click="addExtra()"><?= _r('Add', 'เพิ่ม'); ?></button>
                        </div>
                    </div>
                    <?php endif; ?>
