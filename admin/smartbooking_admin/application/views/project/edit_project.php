        ...
        <div class="modal-dialog modal-lg" role="document" style="height:90vh;">
            <div class="modal-content" style="height:100%;">
                ...
                <div class="modal-body" style="overflow-y:auto;">
                    ...
                    <button class="btn btn-sm" style="float:right; font-size:13px; background-color:#0275d8; color:white; margin-bottom:20px;" @click="loadEditBusiness(0)"><?= _r('Add New Business', 'เพิ่มบริษัทใหม่'); ?></button>
                    <?php endif; ?>
                    ...
                    <div class="col-md-11">
                        ...
                        <div class="row" style="margin-top:15px">
                            <div class="col-md-12" style="text-align:center">
                                <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#0275d8; color:white;" @click="saveBusinessInfo()">{{ edit_business_info.id_business_info == 0 ? '<?= _r("Add", "เพิ่ม"); ?>' : '<?= _r("Update", "แก้ไข"); ?>' }}</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content" style="height:100%;">
                ...
                <div class="modal-body" style="overflow-y:auto;">
                    <div class="col-md-12">
                        ...
                        <div class="row" style="margin-top:15px">
                            <div class="col-md-12" style="text-align:center">
                                <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#0275d8; color:white;" @click="updatePointOfInterest()"><?= _r('Update', 'แก้ไข'); ?></button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="facilityModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel4" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document" style="height:94vh;">
            <div class="modal-content" style="height:100%;">
                ...
                <div class="modal-body" style="overflow-y:auto;">
                    <?php if (has_permission('project_management', 'edit')) : ?>
                    <button class="btn btn-sm" style="float:right; font-size:13px; background-color:#0275d8; color:white; margin-bottom:20px;" @click="loadEditFacility(0)"><?= _r('Add New Facility', 'เพิ่ม Facility ใหม่'); ?></button>
                    <?php endif; ?>
            ...
            <div class="modal-content" style="height:100%;">
                ...
                <div class="modal-body" style="overflow-y:auto;">
                    <div class="col-md-11">
                        ...
                        <div class="row" style="margin-top:15px">
                            <div class="col-md-12" style="text-align:center">
                                <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#0275d8; color:white;" @click="saveFacility()">{{ edit_facility.id_property_facility == 0 ? '<?= _r("Add", "เพิ่ม"); ?>' : '<?= _r("Update", "แก้ไข"); ?>' }}</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content" style="height:100%;">
                ...
                <div class="modal-body" style="overflow-y:auto;">
                    <div class="col-md-12">
                        ...
                        <div class="row" style="margin-top:15px">
                            <div class="col-md-12" style="text-align:center">
                                <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#0275d8; color:white;" @click="updatePolicy()"><?= _r('Update', 'แก้ไข'); ?></button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12" v-show="step == '1'">
                    ...
                    <button class="btn" data-toggle="modal" data-target="#businessModal" style="float:right; width:150px; height:30px; line-height:9px; background-color:#0275d8; color:white;"><?= _r('Edit Business', 'จัดการบริษัท'); ?></button>
                    <?php endif; ?>
                    <div class="col-md-11" style="margin-top:50px;">
                        ...
                        <div class="row" style="margin-top:15px">
                            <div class="col-md-12" style="text-align:center">
                                <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#0275d8; color:white;" @click="saveProjectInfo()"><?= _r('Save', 'บันทึก'); ?></button>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
                    <div class="col-md-11" style="margin-top:50px; text-align:center;" v-if="project_info.id_project_info">
                        ...
                        <div class="row" style="margin-top:15px">
                            <div class="col-md-12" style="text-align:center">
                                <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#0275d8; color:white;" @click="savePhotoProject()"><?= _r('Save', 'บันทึก'); ?></button>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="col-md-12" v-show="step == '2'">
                    <div class="col-md-11" style="margin-top:50px;">
                        ...
                        <div class="row" style="margin-top:15px">
                            <div class="col-md-12" style="text-align:center">
                                <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#0275d8; color:white;" @click="addPointOfInterest()"><?= _r('Add New', 'เพิ่มใหม่'); ?></button>
                            </div>
                        </div>
                        <?php endif; ?>
                ...
                <div class="col-md-12" v-show="step == '3'">
                    <div class="col-md-12" style="margin-top:50px;">
                        <div class="row">
                            <?php if (has_permission('project_management', 'view')) : ?>
                            <div class="col-md-12">
                                <button class="btn" data-toggle="modal" data-target="#facilityModal" style="float:right; width:150px; height:30px; line-height:9px; background-color:#0275d8; color:white;"><?= _r('Edit Facilities', 'จัดการ Facilities'); ?></button>
                            </div>
                            <?php endif; ?>
                        </div>
                ...
                <div class="col-md-12" v-show="step == '4'">
                    <div class="col-md-11" style="margin-top:50px; text-align:center;" v-if="project_info.id_project_info">
                        ...
                        <div class="row" style="margin-top:15px">
                            <div class="col-md-12" style="text-align:center">
                                <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#0275d8; color:white;" @click="savePhotoHighlight()"><?= _r('Save', 'บันทึก'); ?></button>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="col-md-12" v-show="step == '5'">
                    <div class="col-md-11" style="margin-top:50px;">
                        ...
                        <div class="row" style="margin-top:15px">
                            <div class="col-md-12" style="text-align:center">
                                <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#0275d8; color:white;" @click="addPolicy()"><?= _r('Add New', 'เพิ่มใหม่'); ?></button>
                            </div>
                        </div>
                        <?php endif; ?>
