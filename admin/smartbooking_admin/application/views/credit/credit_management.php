                    ...
                    <div class="col-md-11">
                        ...
                        <div class="row" style="margin-top:15px">
                            <div class="col-md-12" style="text-align:center">
                                <button class="btn" style="width:150px; height:30px; line-height:9px; background-color:#0275d8; color:white;" @click="saveCredit()">{{ edit_credit.id_credit == 0 ? '<?= _r('Add', 'เพิ่ม'); ?>' : '<?= _r('Update', 'แก้ไข'); ?>' }}</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-10 offset-md-1">
                    ...
                    <span style="width:100%;">
                        <button class="btn" style="float:right; width:150px; height:30px; line-height:9px; background-color:#0275d8; color:white; margin-bottom:20px;" @click="loadEditCredit(0)">
