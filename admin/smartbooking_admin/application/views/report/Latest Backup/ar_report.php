            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="text-right" style="width:100%; margin-top:10px;">
                        <button class="btn btn-sm btn-success" @click="exportTable()">Export</button>
                    </div>
                            ...
                            <table id="reservationReportTable" class="display fixheader" style="width:100%; min-width:1600px;">
                                ...
                                <tbody style="max-height:420px; display:block; overflow-x:hidden; overflow-y:scroll; font-size:12px;">
                                    <tr v-for="(r, i) in reservations">
                                        ...
                                        <td class="w66 text-center" :data-order="r.credit_term">{{ r.credit_term }}</td>
                                        <td class="w66 text-center" :data-order="r.credit_due_date">{{ convertDateSlash(r.credit_due_date) }}</td>
                            ...
                            <table id="summaryTable" class="display fixheader" style="width:100%; min-width:1600px; margin-top:10px; font-weight:bold; font-size:13px; border:1px !important;">
                                ...
                                <tbody style="max-height:420px; display:block; overflow-x:hidden; overflow-y:hidden;">
                                    <tr class="sum-row">
                                        ...
                                        <td class="w71"></td>
                                        <td class="w71"></td>
                                        <td class="w51">{{ sumByCol_string(reservations, 'length_of_stay') }} </td>
                                        <td class="w76"></td>
                                        <td class="w126"></td>
                                        <td class="w51">{{ sumByCol_stringToArray(reservations, 'pax') }}</td>
                                        <td class="w56"></td>
                            ...
                            <table id="exportTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td>{{ sumByCol_string(reservations, 'length_of_stay') }}</td>
                                        <td></td>
                                        <td></td>
                                        <td>{{ sumByCol_stringToArray(reservations, 'pax') }}</td>
                                        <td></td>
