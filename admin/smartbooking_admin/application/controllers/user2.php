...
class User2 extends MY_Controller {
    ...
    public function auth()
    {
        ...
        if (count($result) == 0) {
			...
			//header("Location: https://smartbooking.installdirect.asia/admin/index.php?message=false");
			header("Location: https://smartbooking.installdirect.asia/admin/index.php?message=false".count($result));
        } else {
            $this->session->set_userdata('user_data', $result[0]);
            // header("Location: ". home_url());
			//http://192.168.20.22/smartbooking_admin/smartbooking_admin_test/user/login
            //header("Location: http://192.168.20.22/smartbooking_admin/smartbooking_admin_test/");
			header("Location: https://smartbooking.installdirect.asia/admin/smartbooking_admin/");
			//header("Location: https://smartbooking.installdirect.asia/admin/index.php?message=false".count($result));
            $ret['result'] = 'true';
        }
