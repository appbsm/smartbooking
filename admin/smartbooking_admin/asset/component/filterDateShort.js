Vue.component("filterdateshort", {
    ...
    `<div class="row">
        ...
        <div class="col-md-6" v-show="filter.range == '' || filter.range == 'Month'">
        ...
        <div class="col-md-3" v-show="filter.range == '' || filter.range == 'Day'">
    ...
    props: ['lang', 'filter', 'current_date_to'],
    data: () => { return {
