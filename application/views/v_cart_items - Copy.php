				...
				<div style="width: 100%; padding: 10px;">
					...
					<div class="col-md-8" style="display: flex; flex-direction: row;">
						<div class="group">
							...
							<input type='text' class=" datepicker search_input" name="check_in_date" id="check_in_date" value="<?=$check_in_date;?>"/>
						</div>
						<div class="group">
							<label for="name"><?php echo $this->lang->line('check_out_date');?></label>
							<input type='text' class=" datepicker search_input" name="check_out_date" id="check_out_date" value="<?=$check_out_date;?>"/>
						</div>
					</div>
							...
							<div class="col-md-10">
								<div class="row">
									...
									<div class="col-md-6 align-self-center">	
										<img class="cart_image" src="<?php echo share_folder_path().$first_photo->room_photo_url;?>" />		
									</div>
