												...
												<div class="row">
													<div class="col-md-12 mb-1">
														<div class="form-outline">
															...
															<input type="text" id="billing_name" name="billing_name" class="form_field form-control " value="" />
													...
													<div class="col-md-12 mb-1">
														<div class="form-outline">
															...
															<textarea id="billing_address" name="billing_address" class="form_field form-control "></textarea>
													...
													<div class="col-md-12 mb-1">
														<div class="form-outline">
															...
															<input type="tel" id="billing_contact_number" name="billing_contact_number" class="form_field form-control contact_number" value="" />
													...
													<div class="col-md-12 mb-1">
														<div class="form-outline">
															...
															<input type="text" id="billing_tax_id" name="billing_tax_id" class="form_field form-control " value="" />
					...
					<div class="col-md-5 pl-4">
						...
						<div class="row justify-content-end">
							<div class="col-12 mt-3 p-0 text-right">
								...
								<button class="btn button-primary" type="submit" id="proceed" disabled><?php echo $this->lang->line('proceed'); ?></button>
							</div>
						</div>
						<!-- Total detail -->
						<div class="row justify-content-end">
...
<script>
	const form = document.getElementById("frm_save");
	...
	$(function() {
		...
		$('#same_billing_info').click(function() {
			if ($(this).is(':checked')) {
				...
				//copy guest info to  billing
				document.getElementById("billing_name").value = document.getElementById("guest_name").value;
				document.getElementById("billing_address").value = document.getElementById("guest_address").value;
				document.getElementById("billing_contact_number").value = document.getElementById("guest_contact_number").value;
				document.getElementById("billing_email").value = document.getElementById("guest_email").value;
				document.getElementById("billing_tax_id").value = document.getElementById("guest_tax_id").value;
			} else {
				//clear billing info
