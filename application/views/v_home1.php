    ...
    <div class="container-fluid text-center ">
		...
		<div class="row mt-1 mb-1">
			<div class="col-md-6">
					...
					<div class="col-md-6">
						<div >
							<button disabled id="search" class="form-control search_input search_button btn-default" data-search-type="search_room" style="cursor: pointer; padding: 0 50px 0 50px;"><?php echo $this->lang->line('search_room');?></button>
						</div>
					</div>
				</div> <!-- diw row -->
			</div> <!-- div col 6 -->
			...
			$photos = $CI->m_room_type->get_room_type_photos($rt->id_room_type);
				...
				<div class="row room_type" style="display: block;">
					...
					<div class="col-md-12">
						...
						?>
						<div class="price" style="margin-left: 10px; margin-right: 10px;"><b><?php echo $price;?></b></div>					
					</div>
					...
					<div class="col-md-12 mb-2 text-center" > 
						...
						<a href="javascript:;" data-roomtype="<?php echo $rt->id_roomtype;?>" class="btn button-primary book_now" id="" style="margin-left: 5px;"><?php echo $this->lang->line('book_now');?></a>
					</div>
