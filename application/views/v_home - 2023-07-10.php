				...
				<div class="row search-bg pt-3" style="border: 1px solid #C6C6C7; border-radius: 5px; padding: 5px 0 5px 0; margin: 0 4px 0 4px;">
					<div class="col-md-3">
						<div class="col-md-12 text-left">
							<label class="ml-1" for="name"><?php echo $lang=="english"?'Location':'ตำแหน่ง'; ?> </label>
					...
					<div class="col-md-3">
						<!-- <div class="col-md-12 mt-2"><b><?php echo $this->lang->line('search_by_room');?></b></div> -->
							<div class="col-md-12 mb-2 text-left">
								...
								<div class="dropdown" >
										<button class="btn dropdown-toggle w-100 search_input" style="color: #495057; width:100%; padding: 0 30px 0 30px;" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					...
					<div class="col-md-2">
						<div>
							...
							<button disabled id="search" class="form-control search_input search_button btn-default" data-search-type="search_room" style="background-color:#81BB4A;cursor: pointer; padding: 0 50px 0 50px;"><?php echo $this->lang->line('search');?></button>
						</div>
					</div>
				</div>
			</div>	
...
<div class="block-control mt-5"></div>
	<!-- Package -->
		<div class="section">
			<div class="container">
				<div class="col-md-6 mb-4 offset-lg-3">
					<div class="section-heading text-center">
						<h5><?php echo ($lang == 'english') ? 'Package' : 'แพ็คเกจ'; ?></h5>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="property-slider-wrap">
										...
										<div class="property-content mt-3">
											...
											<div>
												...
												<div class="col text-center">
													<a href="package/#<?php echo $package->id_project_info . $package->name; ?>" class="btn btn-detail-color py-2 px-3">
														<button disabled id="search_package" class="btn btn-primary-w search_button" data-search-type="search_package" style="cursor: pointer;background-color:#81BB4A;color:white;"><?php echo ($lang == 'english') ? 'Detail' : 'รายละเอียด'; ?></button>
														<!-- <button disabled id="search_package" class="form-control search_input search_button btn-default" data-search-type="search_package" style="cursor: pointer; padding: 0 50px 0 50px;"><?php echo ($lang == 'english') ? 'Detail' : 'รายละเอียด'; ?></button> -->
													</a>
							...
							<div id="property-nav" class="controls ml-1" tabindex="0" aria-label="Carousel Navigation">
					...
					<div class="col-md-12">
						<div class="row">
							<div class="col-md-7" style="background-color:;height:300px">
								...
								?>
									<div style="">
										<img class="room_img" data-type="<?php echo $ctr;?>" data-ctr="<?php echo $ctr1;?>" src="<?php echo share_folder_path().$photo->room_photo_url;?>" width="100%">
									</div>
								<?php }?>
								</div>
							</div>
