	...
	<div class="container-fluid text-center">
		...
		<div class="row" >
			...
			<div class="col-md-12 col-sm-12 mb-2 text-center" > 
				<button class="btn button-primary add_to_cart" data-id="<?php echo $package[0]->id_package;?>" data-price="<?php echo $package[0]->price;?>" id="" style="margin-right: 5px;"><?php echo $this->lang->line('add_to_cart');?></button>
...
function stepper(dis) {
	...
	$(function(){		
		...
		function change_date_calc() {
			...
			var id_room_type = "<?php echo $room_type->id_room_type;?>";
	        $.ajax({
	               method: "POST",
	               url: _url,
	               data: {
