    ...
    <div class="container-fluid text-center ">
		...
		<div class="row mt-1 mb-1">
			<div class="col-md-6">
					...
					<div class="row">
						<div class="col-md-12"><b>Search By Room</b></div>
						<div class="col-md-6">
							<div class="dropdown" >
									  <button class="btn dropdown-toggle w-100 search_input" style="font-size: 1rem!important; width: 30%; padding: 0 30px 0 30px;" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					...
					<div class="col-md-6">
						<div >
							<button id="search" class="form-control search_input btn-default" data-search-type="search_room" style="cursor: pointer; padding: 0 50px 0 50px;"><?php echo $this->lang->line('search');?> Room</button>
						</div>
					</div>
				</div> <!-- diw row -->
			</div> <!-- div col 6 -->
			<div class="col-md-6">
					...
					<div class="row">
						<div class="col-md-12"><b>Search By Package</b></div>
						<div class="col-md-6">
					...
					<div class="col-md-6">
						<div >
							<button id="search_package" class="form-control search_input btn-default" data-search-type="search_package" style="cursor: pointer; padding: 0 50px 0 50px;"><?php echo $this->lang->line('search');?> Package</button>
						</div>
					</div>
				</div> <!-- diw row -->
			</div> <!-- div col 6 -->
