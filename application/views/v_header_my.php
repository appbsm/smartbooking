...
<body>
  <header>
    <nav class="navbar navbar-default navbar-light bg-light fixed-top text-center mr-auto" style="height:70px;background-color:#839287;">
    <div class="container d-flex flex-row">
      ...
      <div class="" id="navbarSupportedContent">       
        <div class="navbar navbar-expand d-flex flex-row">
		  ...
		  <?php if ($id_guest != '') { ?>
		  <a class=""><img src="<?php echo share_folder_path() . $guest->photo_url; ?>" class="rounded-circle mx-auto d-block" style="height:25px;width:25px;" alt=""></a>
		  <div class="input-group d-flex flex-row">            
			<a class="nav-link dropdown-toggle align-text-bottom" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		  ...
		  <div class="button mx-3">
                <a class="btn" style="background-color:#81BB4A; font-size: 1em;" href="<?php echo site_url('login'); ?>" height="20">Sign In</a>
              </div>
		  <?php } ?>
