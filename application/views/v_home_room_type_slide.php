...
@media only screen and (min-width: 601px) and (max-width: 717px) {
	.slideshow { 
	  margin: 50px 10px 10px 10px auto; 
	  padding: 10px; 
	  position: relative; 
		...
		<div class="row" style="padding-top: 50px;">
			...
			<div class="col-md-2">
				<div style="margin-top: 16px; padding-top: 10px;">
					<button id="search" class="form-control search_input btn-default" style="cursor: pointer; padding: 0 50px 0 50px;"><?php echo $this->lang->line('search');?></button>
				</div>
			</div>
		</div>
