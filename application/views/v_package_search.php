  ...
  <div class="container-fluid" >
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="row mb-2">
					<div class="col-md-12 pt-2 price room_type_header text-center">
						<h6><?php echo ($lang == 'english') ? $header[0]->name : $header[0]->name;?> - <?php echo $package_price;?></h6>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 mb-2 text-center" > 
						<button class="btn button-primary-w add_to_cart" data-id="<?php echo $header[0]->id_package;?>" data-price="<?php echo $header[0]->price;?>" id="" style="margin-right: 5px;"><?php echo $this->lang->line('add_to_cart');?></button>
