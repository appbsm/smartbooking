...
<footer class="mt-3 bg-light" style="background-color: #102958 !important; color: rgba(255, 255, 255, 1.00);">
		...
		<div class="footer-top">
			<div class="container">
				<div class="row " id="contactus">
					...
					<div class="col-md-6 col-lg-6 text-right mt-3 tx-moblie-left">							
        ...
        <br>
            ...
            <div class="col-lg-4 col-sm-6 pb-2 d-flex justify-content-center">
                ...
                <i class="las"></i>
				<span style="font-size:14px !important; font-family: Arial, sans-serif !important;"><strong></strong>&nbsp;&nbsp;InstallDirect Co., Ltd. <span><br/>
				<span style="font-size:14px !important; font-family: Arial, sans-serif !important;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;905/7 Rama 3 Road Bangpongpang </span><br/>
                <span style="font-size:14px !important; font-family: Arial, sans-serif !important;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Yannawa, Bangkok, Thailand 10120 </span>
				<br/>
              ...
              <i class="las "></i>
			  <span style="font-size:14px !important; font-family: Arial, sans-serif !important;">
			  ...
			  <span style="font-size:14px !important; font-family: Arial, sans-serif !important;"><strong>&nbsp;&nbsp;&nbsp;FAX :</strong>&nbsp;&nbsp;02-683-4949</span>
              <br/>
              ...
              <span style="font-size:14px !important; font-family: Arial, sans-serif !important;">&nbsp;&nbsp;LINE ID :</strong>&nbsp;&nbsp;<strong>@installdirect</strong></span>
              <br/>
