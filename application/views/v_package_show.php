			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-header">
						<h4 class="modal-title"><?= $this->lang->line('package_warning'); ?></h4>
					...
					<div class="modal-body">
						<?php if ($this->session->flashdata('message_error')) { ?>
							<h6><?= $this->session->flashdata('message_error') ?></h6>
						<?php } ?>
					</div>
											...
											<div class="slideshow" id="slideshow-<?php echo $line_ctr; ?>">
												...
												?>
													<div>
														...
														<img class="room_img img-thumbnail" data-ctr="<?php echo $ctr1; ?>" data-type="<?php echo $room_type->id_room_type; ?>" src="<?php echo share_folder_path() . $photo->room_photo_url; ?>" width="100%">
													</div>
												<?php } ?>
											</div>
