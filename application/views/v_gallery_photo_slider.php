		...
		<div class="row ">
			...
			<div class="col-md-12 d-flex flex-column justify-content-center">
					<div class="col-sm-12 d-flex mb-2" style="text-align: center;">
						<h5 style="" class="gallery_category"><?php echo _r($gallery_photos[0]['description_en'], $gallery_photos[0]['description_th']); ?></h5>
					</div>	
					...
					<div class="col-md-6 mb-3">				
						...
						<img data-ctr="<?php echo $ctr1;?>" src="<?php echo share_folder_path().$g['photo_url'];?>" width="100%" alt="">
						</a>
					</div>
