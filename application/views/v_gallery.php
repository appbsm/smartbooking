	...
	<div class="container">
        <div class="row ">
			...
			<div class="col-md-12 d-flex justify-content-center">
				<div class="row">
					<?php foreach ($gallery_categories as $g) {?>
					<div class="col-6 col-md-3">
						<div class="cover_box">
						<a class=" mt-1 " href="<?php echo site_url('gallery/photo_album').'/'.$g['id_gallery_category']; ?>">
						
						<img src="<?php echo share_folder_path().$g['category_thumbnail'];?>" width="100%">
						<span class="d-flex justify-content-center cover_title" ><?php echo _r($g['gallery_name_en'], $g['gallery_name_th']);?></span>
						</a>
						</div>
					</div>
