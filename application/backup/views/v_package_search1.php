...
<main class="main-2">
    ...
    <div class="container-fluid text-center ">
		...
		<div class="row" style="border: 1px solid #C6C6C7; border-radius: 5px; padding: 5px 0 5px 0; margin: 0 4px 0 4px;">
			<div class="col-md-6">
				<label for="name"><?php echo $this->lang->line('check_in_date');?></label>
			...
			<div class="col-md-12 mt-2">
					...
					<div class="row">
						...
						<div class="col-md-4 mb-2">
							<div class="dropdown" >
									  <button class="btn dropdown-toggle w-100 search_input" style="color: #495057; width: 30%; padding: 0 30px 0 30px;" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									    <span id="div_adult">2</span> <?php echo $this->lang->line('adults');?>, <span id="div_children">0</span> <?php echo $this->lang->line('children');?>
									  </button>
						...
						<div class="col-md-4 mb-2">
							<div class="checkbox-dropdown" style="padding-top: 5px;">
							  ...
							  <ul class="checkbox-dropdown-list">
							    ...
							    <li>
							      <label>
							        <input class="package_cbox" type="checkbox" style="vertical-align: middle;" value="Horsens" name="city" />Package 2</label>
							    </li>
							    <li>
							      <label>
							        <input class="package_cbox" type="checkbox" style="vertical-align: middle;" value="Kolding" name="city" />Package 3</label>
							    </li>
							    <li>
							      <label>
							        <input class="package_cbox" type="checkbox" style="vertical-align: middle; padding: 2px 3px 0 0;" value="Kolding" name="city" />Package 4</label>
							    </li>
							     -->
							  </ul>
							</div>
					...
					<div class="col-md-4">
						<div >
							<button id="search_package" class="form-control search_input search_button btn-default" data-search-type="search_package" style="cursor: pointer; padding: 0 50px 0 50px;"><?php echo $this->lang->line('search_package');?></button>							
						</div>
					</div>
				</div> <!-- diw row -->
			</div> <!-- div col 6 -->
	...
	<div class="container-fluid text-center">
		<div class="row">
		    <div class="col-md-12" style="margin-top:10px;">
				<span class="roomtypes"><?php echo $this->lang->line('search_result'); ?> (<?php echo sizeof($package_result);?>)</span>
			</div>
		</div>
		...
		if (isset($package_result)) {
		$line_ctr = 0;
		foreach ($package_result as $pr) {
			$pr = (array)$pr;
			$header = $pr['header'];
			$room_types = $pr['room_types'];
		$package_price = ($lang == 'english') ? number_format($header[0]->price,0).'/Night' : 'ราคา '.number_format($header[0]->price,0).'/คืน';
		?>

		<div class="col-md-12">
		<div class="row mb-4" style="box-shadow: 2px 2px 2px 2px #C6C6C7; padding: 10px;">
			<div class="col-md-12 price room_type_header" style="margin-left: -1px;"><?php echo ($lang == 'english') ? $header[0]->name : $header[0]->name;?> - <?php echo $package_price;?></div>
			<?php 
			//print_r($room_types);
			...
			?>
				...
				<div class="row room_type" style="display: block;">
						...
						<div class="slideshow" id="slideshow-<?php echo $line_ctr;?>">
								...
								?>
								  <div>
								    ...
								    <img class="room_img" data-type="<?php echo $room_type->id_room_type;?>" src="<?php echo share_folder_path().$photo->room_photo_url;?>" width="100%">
								  </div>
								<?php }?>
							</div>
					</div>
					...
					<div class="col-md-12 mt-3" style="background-color: white;">
						<div class="row">
			...
			<div class="col-md-12 col-sm-12 mb-2 text-center" > 
				<button class="btn button-primary add_to_cart" data-id="<?php echo $header[0]->id_package;?>" data-price="<?php echo $header[0]->price;?>" id="" style="margin-right: 5px;"><?php echo $this->lang->line('add_to_cart');?></button>
				<a href="javascript:;" data-package="<?php echo $header[0]->id_package;?>" data-price="<?php echo $header[0]->price;?>" class="btn button-primary book_now" id="" style="margin-left: 5px;"><?php echo $this->lang->line('book_now');?></a>
			</div>
