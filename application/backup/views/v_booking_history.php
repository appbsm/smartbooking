...
<div class="main-2" style="height:500px">
	<div class="container" >
  		<div class="row">
		...
		<div class="row">
			  ...
			  <div class="sidenav">
					...
					<div class="dropdown">
						<a href="history" style="color:#81BB4A;margin-left:10px;">ประวัติการจอง</a>
					</div>
					...
					<a href="<?php echo site_url('profile');?>" class="dropdown-btn">ข้อมูลส่วนตัว
