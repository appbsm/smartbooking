			...
			<div class="page_content">
				<div class="row">
					<div class="col-md-6 col-sm-6 d-flex flex-row">
						<img src="<?php echo share_folder_path();?>images/SMS_Logo_Final.png"  style="max-width: 100px;">
						<span style="display: block; margin-top: auto; padding-bottom: 10px; font-size: 1.3em!important; font-weight: bold;"><?php echo ($lang == 'english') ? $project_info->project_name_en : $project_info->project_name_th;?></span>
					</div>
				...
				<div class="row mt-3">
					<div class="col-md-6 col-sm-6">
						<div class="row" style="margin-left: 15px; ">
							...
							<div class="col-md-7 mb-2"><?php echo ($lang == 'english') ? $project_info->business_name_en : $project_info->business_name_th;?></div>
							<div class="col-md-5 mb-2"><?php echo $this->lang->line('company_address');?>: </div>
							<div class="col-md-7 mb-2"><?php echo ($lang == 'english') ? $project_info->business_address_en : $project_info->business_address_th;?></div>
