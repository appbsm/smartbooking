...
<body>
  <header>
    <nav class="navbar navbar-expand-md navbar-light fixed-top bg-light text-center mr-auto" style="height:70px">
      ...
      <span style="padding: 10px;"><a class="logo" href="<?php echo site_url('home'); ?>"><img src="<?php echo site_url(); ?>images/10.png" width="70"></a></span>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="navbar" style="float: right;">
          ...
          <ul class="navbar-nav ml-auto" style="float: right; margin-left: auto; margin-right: 40px;">
            <?php if ($id_guest != '') { ?>
            ...
            <?php } ?>
            <li class="nav-item">
              <div style="margin-top:3px;padding: 5px; text-align: right;">
                <?php
                $switch_en = 'English';
                $switch_th = 'Thai';
                ?>
