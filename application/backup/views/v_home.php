								...
								<?php foreach ($packages as $package) { ?>
									<div class="property-item">
										<!-- <a href="property-single.html" class="img"> -->
											<img src="<?= base_url() ?>/images/home/Home_7.jpg" alt="Image" class="img-fluid" />
										<!-- </a> -->
										<div class="property-content">
											...
											<div>
												...
												<button disabled id="search_package" class="form-control search_input search_button btn-default" data-search-type="search_package" style="cursor: pointer; padding: 0 50px 0 50px;">รายละเอียด</button>
												</a>
											</div>
										</div>
									</div>
