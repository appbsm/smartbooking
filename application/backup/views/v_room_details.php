...
<main class="main-2">
 ...
 <div class="container-fluid" > 
  	<div class="row">
  		<div class="col-md-12 price room_type_header"><span style="margin-left: 10px;"><?php echo ($lang == 'english') ? $room_type->room_type_name_en : $room_type->room_type_name_th;?></span></div>
  	</div>
  	<div class="row"> 
    	...
    	<div class="col-md-6" style="padding-right: 30px;">
    		<div class="row">
    			...
    			<img class="myImg imgThumbnail_bg img_border" data-id="<?php echo $ctr;?>" src="<?php echo share_folder_path().$photo;?>" style="max-width: 100%;">
    			</div>
    			<?php }
    			}
    			?>
	...
	<div class="row mx-auto mt-5 mb-5">
		...
		<div class="col-md-4 ">
			...
			<div class="row mb-4" style="width: 100%; border: 1px solid #7F8C8D; border-radius: 10px; ">
				<div class="col-md-12 price mt-4" style="font-size: 1.2em; font-weight: bold; text-align: center; width: 100%;">
				<span id="hdr_room_rate"><?php echo number_format($rate,2);?></span> / <?php echo $this->lang->line('night');?>
				<div style="margin: auto; font-size: 0.8em;">(<?php echo $this->lang->line('vary_price');?>)</div>
				</div>
				...
				<div class="col-md-12 mb-3">
					<div class="dropdown" >
						  <button class="btn dropdown-toggle w-100 search_input" style="width: 30%; padding: 0 30px 0 0" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					...
					<div class="col-md-6 mb-2 text-right" > 
						<button class="btn button-primary form-control add_to_cart" data-id="<?php echo $rt->id_room_type;?>" data-price="<?php echo $rt->default_rate;?>" id="add_to_cart"><?php echo $this->lang->line('add_to_cart');?></button>
					</div>
