				...
				<div class="row">
					<div class="col-md-7">
						...
						<div class="row justify-content-end">
							<div class="col-12 mt-3 p-0 text-right">
								<button class="btn button-primary" id="proceed" disabled><?php echo $this->lang->line('proceed'); ?></button>
							</div>
						</div>
					</div>
					...
					<div class="col-md-5 pl-4">
											...
											<div class="row room_type">
														...
														<div class="row">
															...
															$details[] = '
																...
																';
																		...
																		<div class="col-md-2 icon_container" >
																			<span class="icon-content" style="margin-left:1px; margin-top:-3px;"><img class="icon" src="' . share_folder_path() . 'images/icons/icons8-bedroom-50.png" height="18"></span>
																		</div>
																		<div class="col-md-9 icon_container">
																...
																';
																		...
																		<div class="col-md-2 icon_container" >
																			<span class="icon-content" style="margin-left:4px; margin-top:-1px;"><img class="icon" src="' . share_folder_path() . 'images/icons/bathroom.png" height="18"></span>
																		</div>
																		<div class="col-md-9 icon_container">
												...
												<div class="row">
														<div class="col-md-12">
															<div class="row">
																<div class="col-12">
																	<label for="name">วันที่เข้าพัก</label>
																</div>
															</div>
															...
															<div class="row">
																<div class="col-12">
																	<label for="name"><?php echo $check_in_date; ?> - <?php echo $check_out_date; ?></label>
																</div>
															</div>
	    					...
	    					';
								...
								<!-- Total detail -->
								<div class="row justify-content-end">
									<div class="col-md-9 border-r-10 mt-3">
