...
<div class="main-2">
	<div class="container" >
		...
		<div class="row">
			<div class="col-md-2">
				<div class="sidenav">
					<a class="dropdown-btn">ประวัติการจอง
					</a>
					<div class="dropdown-container">
						<a href="#">ประวัติการจอง</a>
					</div>
					<a class="dropdown-btn">โค้ดส่วนลด
					</a>
					<div class="dropdown-container">
						<a href="#">โค้ดส่วนลด</a>
					</div>
					<a class="dropdown-btn">ความปลอดภัย
					</a>
					<div class="dropdown-container">
						<a href="#">รหัสผ่าน</a>
					</div>
					<a class="dropdown-btn">ข้อมูลส่วนตัว
			...
			<div class="col-md-10">
				<form name="frm_save1" id="frm_save1" method="post" action="<?php echo site_url('profile') . '/update_profile'; ?>" enctype="multipart/form-data">
					<div class="row border-r-10 mt-5">
						<div class="col collapse show" id="collapse-name">
							<div class="row" style="height:200px;">
								<div class="col-2 mt-5"><img src="<?php echo share_folder_path() . $guest_info->photo_url; ?>" class="rounded-circle mx-auto d-block" style="height:100px;width:100;" alt=""></div>
								<div class="col-8 mt-5">
									<br><br>
									<h4><?php echo $guest_info->firstname; ?> <?php echo $guest_info->lastname; ?></h4>
								</div>
								<div class="col-2 mt-4"><a data-toggle="collapse" data-target="#demo">แก้ไข</a></div>
							</div>
						</div>
					</div>

					<div class="row border-r-10 mt-5">
						<div class="col collapse show" id="collapse-email">
							<div class="row" style="height:200px;">
								<div class="col-2"></div>
								<div class="col-8 mt-5">
								...
								<div class="col-2 mt-4"><a data-bs-toggle="collapse" href="#collapse-email" role="button" aria-expanded="false" aria-controls="collapse-email">แก้ไข</a></div>
							</div>
						</div>
					...
					<div class="row border-r-10 mt-5">
						<div class="col collapse show" id="collapse-phone">
							<div class="row" style="height:200px;">
								<div class="col-2"></div>
								<div class="col-8 mt-5">
									<div class="form-outline">
										<label class="form-label" for="contact_number"><span class="required">*</span><?php echo $this->lang->line('contact_number'); ?></label>
										<input type="tel" id="contact_number" name="contact_number" class="form-control" value="<?php echo $guest_info->contact_number; ?>" required disabled/>
									</div>
								</div>
								<div class="col-2 mt-4"><a data-bs-toggle="collapse" href="#collapse-phone" role="button" aria-expanded="false" aria-controls="collapse-phone">แก้ไข</a></div>
							</div>
						</div>
					...
					<div class="row border-r-10 mt-5">
						<div class="col collapse show" id="collapse-address">
							<div class="row" style="height:200px;">
								<div class="col-2"></div>
								<div class="col-8 mt-5">
									<div class="form-outline">
								...
								<div class="col-2 mt-4"><a data-bs-toggle="collapse" href="#collapse-address" role="button" aria-expanded="false" aria-controls="collapse-address">แก้ไข</a></div>
							</div>
						</div>				
